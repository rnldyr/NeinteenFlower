<%@ Page Title="Insert Employee" Language="C#" MasterPageFile="~/View/Header.Master" AutoEventWireup="true" CodeBehind="InsertEmployee.aspx.cs" Inherits="NeinteenFlower.View.InsertEmployee" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <asp:Label ID="lblTitle" runat="server" Text="Insert Employee" Font-Bold="true"></asp:Label>
    </div>
    <div>
